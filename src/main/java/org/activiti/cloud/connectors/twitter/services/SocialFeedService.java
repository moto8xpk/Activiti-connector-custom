...
public class SocialFeedService {
    ...
    @StreamListener(value = CampaignMessageChannels.CAMPAIGN_CHANNEL)
    public void handleCampaignEvent(Tweet t) {
        logger.info(append("service-name", appName), ">>> Received event: " + t);
        // Thêm logic xử lý event ở đây
        // Ví dụ: xử lý logic kinh doanh hoặc lưu trữ dữ liệu
    }
